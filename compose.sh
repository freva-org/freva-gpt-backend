...
podman run -d --name freva-gpt-2-backend-instance -p 8502:8502 -v /work:/work:ro -v ./logs:/app/logs -v ./threads:/app/threads -v ./target:/app/target -v ./testdata:/data/inputFiles -v ./python_pickles:/app/python_pickles --network freva-gpt --dns 127.0.0.11 --dns 10.0.252.1 freva-gpt2-backend 
#          ^    	    ^				^           ^             ^                   ^                         ^                       ^                               ^                                      ^ 
# Runs the Image            | 				|           |             |                   |                         |                       |                               |                                      | 
