...
pub static ALL_TOOLS: once_cell::sync::Lazy<Vec<async_openai::types::ChatCompletionTool>> = once_cell::sync::Lazy::new(|| vec![
    code_interpreter::CODE_INTERPRETER_TOOL_TYPE.clone(),
]);